...
export default function Investors() {
  ...
  const metrics = [
    { icon: <Users className="h-12 w-12" />, value: '500+', label: 'Active Businesses', color: 'wynaxa-purple' },
    { icon: <Globe className="h-12 w-12" />, value: '50+', label: 'Communities Served', color: 'wynaxa-blue' },
    { icon: <TrendingUp className="h-12 w-12" />, value: '2M GBP', label: 'Local Impact Created', color: 'wynaxa-green' },
