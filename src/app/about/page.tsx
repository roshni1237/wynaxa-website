...
export default function About() {
  const timeline = [
    ...
    { year: '2023', event: 'Ireland HQ Established', description: 'Expanded operations with our European headquarters' },
    { year: '2024', event: 'Ecosystem Launch', description: 'Launched our complete suite of community-focused products' },
    { year: '2025', event: 'Future Roadmap', description: 'Scaling to 100+ communities and expanding internationally' }
  ]
