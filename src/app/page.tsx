...
export default function Home() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      title: 'Award Winning',
      description: 'Recognized for innovation in community-focused fintech'
    },
    {
      ...
      <section className="section-padding bg-gradient-to-r from-wynaxa-purple/10 via-wynaxa-blue/10 to-wynaxa-green/10">
        <div className="container container-padding">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">Our Impact</h2>
            <p className="text-lg sm:text-xl text-muted-foreground">Real results from real communities</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <Card className="border-2 bg-gradient-to-br from-background to-wynaxa-purple/10 hover:shadow-2xl transition-all duration-500">
              <CardContent className="pt-8 text-center">
                ...
                <div className="text-4xl sm:text-5xl font-bold mb-2 gradient-text">{stats.businesses}+</div>
                <p className="text-sm sm:text-base text-muted-foreground font-medium">Businesses Empowered</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 bg-gradient-to-br from-background to-wynaxa-blue/10 hover:shadow-2xl transition-all duration-500">
              <CardContent className="pt-8 text-center">
                ...
                <div className="text-4xl sm:text-5xl font-bold mb-2 gradient-text">{stats.communities}+</div>
                <p className="text-sm sm:text-base text-muted-foreground font-medium">Communities Connected</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 bg-gradient-to-br from-background to-wynaxa-green/10 hover:shadow-2xl transition-all duration-500">
              <CardContent className="pt-8 text-center">
                ...
                <div className="text-4xl sm:text-5xl font-bold mb-2 gradient-text">{formatNumber(stats.funds)}</div>
                <p className="text-sm sm:text-base text-muted-foreground font-medium">Local Funds Reinvested</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 bg-gradient-to-br from-background to-wynaxa-orange/10 hover:shadow-2xl transition-all duration-500">
              <CardContent className="pt-8 text-center">
                ...
                <div className="text-4xl sm:text-5xl font-bold mb-2 gradient-text">{formatNumber(stats.carbon)}</div>
                <p className="text-sm sm:text-base text-muted-foreground font-medium">kg Carbon Saved</p>
              </CardContent>
            </Card>
          </div>
        </div>
